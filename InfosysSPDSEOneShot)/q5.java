...
public class q5 {
   ...
   * - His vacation ends the day before obligation (R + 1), or day N if R == M -
   * 1.
   *
  ...
  public static void main(String[] args) {
    ...
    // L=1, R=1 (cancel d[1]=6): start = d[0]+1 = 4, end = d[2]-1 = 7 -> 4 days (4
    // to 7)
 ...
 * If R == M - 1: There are no obligations after R, so Andy can vacation until
 * Day N.
